...
legitimate_domains = ['example.com', 'google.com', 'yahoo.com']

test_urls = ['http://example.co', 'http://examp1e..com', 'https://www.google.security-updatte.com', 'http://yahoo.com', 'https://google.com']
